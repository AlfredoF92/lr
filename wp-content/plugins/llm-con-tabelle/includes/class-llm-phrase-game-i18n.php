	...
	private static function bundles() {
		...
		$cache = array(
			'it' => array(
				...
				'input_placeholder_phase1' => 'Scrivi in %s',
				'input_placeholder_phase2' => 'Scrivi in %s',
			...
			'play_inverted_prompt'   => 'Questa è la traduzione in %1$s. Scrivi la frase originale in %2$s, oppure vai avanti quando vuoi…',
		...
		'en' => array(
				...
				'input_placeholder_phase1' => 'Write in %s',
				'input_placeholder_phase2' => 'Write in %s',
			...
			'play_inverted_prompt'   => 'This is the translation in %1$s. Write the original sentence in %2$s, or move on whenever you want…',
		...
		'pl' => array(
				...
				'input_placeholder_phase1' => 'Napisz w języku: %s',
				'input_placeholder_phase2' => 'Napisz w języku: %s',
			...
			'play_inverted_prompt'   => 'To jest tłumaczenie na %1$s. Napisz oryginalne zdanie w języku: %2$s, albo idź dalej, kiedy chcesz…',
		...
		'es' => array(
				...
				'input_placeholder_phase1' => 'Escribe en %s',
				'input_placeholder_phase2' => 'Escribe en %s',
			...
			'play_inverted_prompt'   => 'Esta es la traducción al %1$s. Escribe la frase original en %2$s, o avanza cuando quieras…',
